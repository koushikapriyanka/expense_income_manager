...
ActiveRecord::Schema.define(version: 20170712055407) do
  ...
  create_table "income_expense_category_mappings", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "category_id"
    t.string  "categorized_type"
    t.integer "categorized_id"
    t.index ["categorized_type", "categorized_id"], name: "categorized_idx", using: :btree
    t.index ["category_id"], name: "index_income_expense_category_mappings_on_category_id", using: :btree
  end
